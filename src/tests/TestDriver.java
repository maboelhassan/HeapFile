...
public class TestDriver {
  ...
  //  sprintf( logpath, MINIBASE_LOG, nameRoot, getpid() );
    ...
    //dependent. 
    dbpath = "C:\\Users\\Ahmed\\Desktop\\"+nameRoot+System.getProperty("user.name")+".minibase-db"; 
    logpath = "C:\\Users\\Ahmed\\Desktop\\"+nameRoot +System.getProperty("user.name")+".minibase-log"; 
  }
